...
/** Centralized logger bridging java.util.logging to QwenConsole. */
public final class QwenLogger {
    ...
    public static synchronized QwenLogger getInstance() {
        if (instance == null) instance = new QwenLogger();
        return instance;
    }
    ...
    private QwenLogger() {
        ...
        LOGGER.addHandler(new Handler() {
            @Override public void publish(LogRecord record) {
                if (sink != null) sink.append("[" + record.getLevel().getName() + "] " + record.getMessage());
            }
    ...
    public void setSink(ConsoleSink s) { this.sink = s; }
    public void log(Level level, String msg) { LOGGER.log(level, msg); }
    public void log(Level level, String msg, Throwable t) { LOGGER.log(level, msg, t); }
    ...
    public interface ConsoleSink { void append(String line); }
}
