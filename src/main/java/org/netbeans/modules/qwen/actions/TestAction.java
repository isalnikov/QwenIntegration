...
public final class TestAction extends AbstractAction {
    ...
    public TestAction() { putValue(NAME, "Qwen: Write Unit Tests"); }
    @Override public void actionPerformed(ActionEvent e) { JTextComponent ed = get(); if(ed==null){warn("No editor.");return;} try{IO.getOut().println("=== Qwen: Unit Tests ===");IO.select();}catch(Exception ex){}}
