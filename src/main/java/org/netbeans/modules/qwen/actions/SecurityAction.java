...
public final class SecurityAction extends AbstractAction {
    ...
    public SecurityAction() { putValue(NAME, "Qwen: Find Vulnerabilities"); }
    @Override public void actionPerformed(ActionEvent e) { JTextComponent ed = get(); if(ed==null){warn("No editor.");return;} try{IO.getOut().println("=== Qwen: Security Scan ===");IO.select();}catch(Exception ex){}}
